 ...
 */
export type ModelDefinition<T extends Model = Model> = ModelClass<T> & {
 ...
 */
export type RawModel<T extends object> = Partial<OmitByTypeRecursive<Omit<T, "__dirty" | "Events" | "__type" | "__types" | "_new" | "context">, Function>>;
