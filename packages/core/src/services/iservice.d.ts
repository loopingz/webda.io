...
import { StateOptions } from "@webda/utils";
 ...
 */
export declare const ServiceState: (options: StateOptions<ServiceStates>) => (value: any, context: ClassMemberDecoratorContext) => void;
export type ServicePartialParameters<T extends ServiceParameters> = DeepPartial<Attributes<T>>;
/**
 * Represent a Webda service
 */
export declare abstract class AbstractService<T extends ServiceParameters = ServiceParameters, E extends AsyncEventUnknown = {}> extends AsyncEventEmitterImpl<E> {
     ...
     */
    abstract getOpenApiReplacements(): {
        [key: string]: string;
    };
}
/**
