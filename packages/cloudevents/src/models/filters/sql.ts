 ...
 */
class BinaryMultiplicativeExpression extends Expression {
  /**
   *
   * @param left part of the expression
   * @param right part of the expression
 ...
 */
class BinaryAdditiveExpression extends Expression {
  /**
   *
   * @param left part of the expression
   * @param right part of the expression
 ...
 */
class BinaryComparisonExpression extends Expression {
  /**
   *
   * @param left part of the expression
   * @param right part of the expression
 ...
 */
class BinaryLogicExpression extends Expression {
  /**
   *
   * @param left part of the expression
   * @param right part of the expression
