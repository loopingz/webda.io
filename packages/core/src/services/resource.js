...
export class ResourceServiceParameters extends ServiceParameters {
    constructor(params) {
        ...
        this.cacheControl ?? (this.cacheControl = "public, max-age=31536000");
        this.indexCacheControl ?? (this.indexCacheControl = "no-cache, no-store, must-revalidate");
        ...
        this.allowHiddenFiles ?? (this.allowHiddenFiles = false);
    }
}
/**
