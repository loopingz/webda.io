...
## [4.0.0-beta.2](https://github.com/loopingz/webda.io/compare/shell-v4.0.0-beta.1...shell-v4.0.0-beta.2) (2026-02-20)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @webda/kubernetes bumped from ^3.4.2 to ^4.0.0-beta.1
