...
export declare const Route: {
    (value: any, context: ClassMethodDecoratorContext<any, any>): any;
    (route: string, methods?: HttpMethodType | HttpMethodType[], openapi?: OpenAPIWebdaDefinition): (value: any, context: ClassMethodDecoratorContext<any, any>) => any;
};
/**
...
export interface IRouter {
    ...
    registerRequestFilter(filter: RequestFilter): any;
    registerCORSFilter(filter: RequestFilter): any;
    execute(context: IWebContext): Promise<void>;
}
//# sourceMappingURL=irest.d.ts.map