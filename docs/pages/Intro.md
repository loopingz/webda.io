...
It provides the features we think every application should have: Authentication, Authorization, Logging, Monitoring, Configuration, Database Abstraction, Realtime events, GraphQL, REST API, gRPC.
...
It is articulated around 4 main concepts:
 ...
 - Operations: Define one action in the framework, it can be defined by a Service or a Model
