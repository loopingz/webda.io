import { Attributes, FilterAttributes } from "@webda/tsc-esm";
/**
...
export interface StoreHelper<T extends object = object> {
     ...
     * @returns
     */
    incrementAttributes<K extends Attributes<T>, L extends FilterAttributes<T, number>>(uuid: string, info: ({
        property: L;
        value?: number;
    } | L)[], conditionField?: K, condition?: T[K]): Promise<void>;
    /**
     ...
     * @returns
     */
    upsertItemToCollection<K extends FilterAttributes<T, Array<any>>>(uuid: string, collection: K, item: any, index?: number, itemWriteConditionField?: any, itemWriteCondition?: any): Promise<void>;
    /**
     ...
     * @returns
     */
    deleteItemFromCollection<K extends FilterAttributes<T, Array<any>>>(uuid: string, collection: K, index: number, itemWriteConditionField?: any, itemWriteCondition?: any): Promise<void>;
    /**
     ...
     * @returns
     */
    removeAttribute<L extends Attributes<T>, K extends Attributes<T>>(uuid: string, attribute: K, conditionField?: L, condition?: T[L]): Promise<void>;
}
/**
